...
LOGGING_DIR=./www-test/kdd_1shot/kdd-supernet-default-binomial-0.5-autoctr-ea-240gen-128pop-64sample-8childs-default-ft_lr0.04-${zico_coef}zico_${fr_coef}fr-new
